        ...
        <footer className="pt-20">
            <div className="container mx-auto py-4 text-center text-gray-600 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center">
                    <h3 className="font-bold text-[30px] mb-2">Blogy</h3>
                    <p>
                ...
                <div className="text-center">
                    <h3 className="font-bold text-[30px] mb-2">Quick Links</h3>
                ...
                <div className="text-center">
                    <h3 className="font-bold text-[30px] mb-2">Legal Stuff</h3>
